RSpec.describe 'Post', type: :model do
  ...
  context 'with validation' do
    ...
    it 'checks empty description' do
      ...
      subject.valid?
      expect(subject.errors[:description]).to include t('activerecord.errors.models.user.attributes.description.blank')
    end

    it 'checks length of title is not more than 255 characters' do
      subject.title = 'hello' * 70
      subject.valid?
      msg = t('activerecord.errors.models.user.attributes.title.too_long', count: 255)
